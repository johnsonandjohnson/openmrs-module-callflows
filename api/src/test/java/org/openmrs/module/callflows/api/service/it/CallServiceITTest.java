...
public class CallServiceITTest extends BaseModuleContextSensitiveTest {
  ...
  public void setUp() throws IOException {
    ...
    mainFlow = callFlowService.saveCallFlow(mainFlow);
  ...
  public void shouldCreateInboundCallWithActor() {
    ...
    Call newCall =
        callService.create(
            ...
            Constants.EXTERNAL_TYPE,
            Constants.PLAYED_MESSAGES,
            null,
            params);
  ...
  public void shouldUpdateOnlyAllowedFieldsInCall() {
    ...
    callService.saveCall(outboundCall);
  ...
  public void shouldNotMakeCallIfBadConfigWasProvidedInMakeCall() {
    ...
    // When
    Call call =
        callService.makeCall(Constants.CONFIG_VOXEO + "Bad", Constants.CALLFLOW_MAIN, params);
  ...
  public void shouldNotMakeCallIfBadCallFlowWasProvidedInMakeCall() {
    ...
    // When
    Call call =
        callService.makeCall(Constants.CONFIG_VOXEO, Constants.CALLFLOW_MAIN + "Bad", params);
