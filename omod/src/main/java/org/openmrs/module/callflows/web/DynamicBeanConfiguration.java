...
package org.openmrs.module.callflows.web;
...
@Configuration("callflows.dynamicBeanConfiguration")
...
public class DynamicBeanConfiguration {
  ...
  public AbstractHandlerExceptionResolver getHandlerExceptionResolver() throws Exception {
    ...
    HttpMessageConverter<?> stringHttpMessageConverter = Context.getRegisteredComponent(
        "cfStringConverter", HttpMessageConverter.class);

    HttpMessageConverter<?> jsonHttpMessageConverter = Context.getRegisteredComponent("cfJsonConverter",
